...
<body ng-app="pinyougou" ng-controller="indexController" ng-init="num=1;loadSku()">
                    ...
                    <div id="specification" class="summary-wrap clearfix">
                        ...
                        <dl>
                            ...
                            <#list specification.attributeValue as item>
                                <dd><a href="#" ng-click="selectSpecification('${specification.attributeName}','${item}')" class="{{isSelected('${specification.attributeName}','${item}')?'selected':''}}">${item}<span title="点击取消选择">&nbsp;</span></a></dd>
                            </#list>
                        </dl>
                        </#list>
                    </div>
